...
import '../models/ModelMultiCurrencyList.dart';
import '../utils/ApiConstant.dart';
import '../routers/my_router.dart';
import 'package:get/get.dart';

Future<ModelMultiCurrencyList> getMultiCurrencyList() async {
  ...
  http.Response response = await http.post(Uri.parse(ApiUrls.multiCurrencyList),
      body: jsonEncode(map), headers: headers);

  if (response.statusCode == 200) {
    EasyLoading.dismiss();
    return ModelMultiCurrencyList.fromJson(json.decode(response.body));
  } else {
    EasyLoading.dismiss();
